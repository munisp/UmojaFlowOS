...
export function RegulatoryDeadlineForm({ submit, pending, error }: { submit: (input: { regulator: Regulator; corridor: Corridor; title: string; dueAt: Date; sourceReference: string }) => void; pending: boolean; error?: string | null }) {
