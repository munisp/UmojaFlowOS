...
export function PaymentOrderForm({
  ...
  >
    <Label className="grid gap-1.5"><span className="text-[10px] font-black uppercase tracking-[0.14em] text-black/50">Idempotency key</span><Input name="idempotencyKey" required minLength={8} maxLength={120} className="rounded-none border-black/25" placeholder="Caller-supplied unique instruction key" /></Label>
