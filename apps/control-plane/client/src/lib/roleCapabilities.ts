...
export type ConsoleAction = "counterparty" | "integration" | "alert" | "policy" | "case" | "sar-str" | "report" | "deadline" | "customer" | "beneficiary" | "liquidity" | "market" | "rate-lock" | "payment" | "payment-leg" | "evaluate-deadlines";
...
export function canPerformConsoleAction(role: OperatorRole | undefined, action: ConsoleAction): boolean {
  ...
  if (role === "compliance_officer") return ["policy", "case", "sar-str", "report", "deadline"].includes(action);
