...
import { cancelPostgresRateLock, createPostgresBeneficiary, createPostgresComplianceCase, createPostgresCounterparty, createPostgresCounterpartyAuthorization, createPostgresCounterpartyRiskAssessment, createPostgresCustomer, createPostgresDocumentAnalysisJob, createPostgresKycDocumentUploadIntent, createPostgresRegulatoryReportDraft, createPostgresReviewerDecision, createPostgresSarStrFiling, createPostgresTreasuryRecommendation, createPostgresVerificationConsent, decidePostgresTreasuryRecommendation, escalatePostgresCounterpartyRiskAssessment, finalizePostgresKycDocumentUpload, getPostgresCutoverReadiness, getPostgresReadiness, listPostgresBeneficiaries, listPostgresComplianceCases, listPostgresCounterparties, listPostgresCounterpartyAuthorizations, listPostgresCustomers, listPostgresDocumentAnalysisEvidence, listPostgresDocumentAnalysisJobs, listPostgresKycDocuments, listPostgresLiquidityPositions, listPostgresNotificationDeliveries, listPostgresRegulatoryDeadlines, listPostgresRegulatoryReports, listPostgresReviewerDecisions, listPostgresSarStrFilings, listPostgresVerificationConsents, persistPostgresDocumentAnalysisEvidence, recordPostgresLiquidityPosition, transitionPostgresCounterpartyAuthorization, transitionPostgresRegulatoryReport, transitionPostgresSarStrFiling, updatePostgresKycDocumentReview } from "./postgres";
...
export const appRouter = router({
  ...
  postgres: router({
    ...
    verificationConsents: auditorProcedure.query(() => listPostgresVerificationConsents()),
