-- Immutable operational evidence for an approved MySQL/TiDB to PostgreSQL cutover.
-- This migration stores snapshot metadata and reconciliation results only; it never stores source payload bytes.
